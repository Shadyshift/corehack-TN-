...
import me.alpha432.oyvey.features.modules.combat.FightBot;
import me.alpha432.oyvey.features.modules.combat.Rage;
...
public class ModuleManager implements Jsonable, Util {
    ...
    public void init() {
        ...
        modules.add(new FightBot());
        modules.add(new Rage());
        modules.add(new MCF());
